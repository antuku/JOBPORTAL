...
$sql = "SELECT * FROM `tblcompany` c,`tbljob` j WHERE c.`COMPANYID`= $jobid AND j.`JOBID` = $jobid ORDER BY j.`DATEPOSTED` DESC" ;
$mydb->setQuery($sql);
                                  ...
                                  <div class="row contentbody">
                                        <div class="col-md-6">
                                            <ul>
                                                ...
                                                <li><i class="fp-ht-food"></i>Salary : <?php echo number_format($result->SALARIES);  ?></li>
