   <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo web_root; ?>plugins/jobportal/images/cover_image.jpg');" data-stellar-background-ratio="0.5">
